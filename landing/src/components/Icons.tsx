/**
 * Platform and UI Icons
 *
 * High-quality SVG icons for the landing page.
 * All icons are designed to work at various sizes and maintain clarity.
 */
...
/**
 * Apple logo - Official Apple icon shape
 */
...
/**
 * Windows logo - Four-panel window design
 */
...
/**
 * Linux Tux penguin - The official Linux mascot
 */
export function LinuxIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.504 0c-.155 0-.315.008-.48.021-4.226.333-3.105 4.807-3.17 6.298-.076 1.092-.3 1.953-1.05 3.02-.885 1.051-2.127 2.75-2.716 4.521-.278.832-.41 1.684-.287 2.489a.424.424 0 00-.11.135c-.26.268-.45.6-.663.839-.199.199-.485.267-.797.4-.313.136-.658.269-.864.68-.09.189-.136.394-.132.602 0 .199.027.4.055.536.058.399.116.728.04.97-.249.68-.28 1.145-.106 1.484.174.334.535.47.94.601.81.2 1.91.135 2.774.6.926.466 1.866.67 2.616.47.526-.116.97-.464 1.208-.946.587.26 1.24.43 1.922.43.682 0 1.335-.17 1.922-.43.238.482.683.83 1.208.946.75.2 1.69-.004 2.616-.47.865-.465 1.964-.4 2.774-.6.405-.13.766-.267.94-.6.174-.34.142-.804-.106-1.484-.076-.242-.018-.571.04-.97.027-.136.055-.337.055-.536.003-.208-.042-.413-.132-.602-.206-.411-.551-.544-.864-.68-.312-.133-.598-.2-.797-.4a4.07 4.07 0 01-.663-.839.424.424 0 00-.11-.135c.123-.805-.009-1.657-.287-2.489-.589-1.77-1.831-3.47-2.716-4.521-.75-1.067-.974-1.928-1.05-3.02-.065-1.491 1.056-5.965-3.17-6.298-.165-.013-.325-.021-.48-.021zm-1.588 5.89c.144 0 .288.017.425.05.905.22 1.477 1.16 1.28 2.102-.197.942-1.097 1.546-2.002 1.327-.905-.22-1.478-1.16-1.28-2.102.166-.793.844-1.377 1.577-1.377zm3.17 0c.733 0 1.411.584 1.577 1.377.198.942-.375 1.883-1.28 2.102-.905.22-1.805-.385-2.002-1.327-.198-.942.375-1.882 1.28-2.102.137-.033.28-.05.425-.05zm-4.803 5.752c.073-.003.148.003.223.018.455.09.756.53.673.98-.082.452-.508.762-.962.693a.812.812 0 01-.67-.93c.066-.364.378-.653.736-.761zm6.441 0c.358.108.67.397.736.761a.812.812 0 01-.67.93c-.454.069-.88-.24-.962-.693-.083-.45.218-.89.673-.98.075-.015.15-.021.223-.018zm-5.062 2.594c.153 0 .305.012.453.036 1.177.189 2.021 1.134 2.206 2.159h-.002c.038.203.057.413.053.626 0 .094-.006.188-.018.28-.066.499-.261.963-.577 1.357.003.004.007.008.01.012.14.175.262.367.375.58a4.52 4.52 0 01.49-.115 4.4 4.4 0 011.175-.007c.152-.35.257-.723.31-1.11.011-.09.017-.182.018-.274.001-.214-.017-.424-.055-.63.186-1.025 1.03-1.97 2.207-2.159.147-.024.299-.036.452-.036.609 0 1.19.185 1.65.532-.178-.625-.521-1.213-1.01-1.696-.677-.67-1.58-1.043-2.543-1.052h-.019c-.443 0-.88.083-1.289.245a3.95 3.95 0 00-.675.349 3.866 3.866 0 00-.675-.349 3.572 3.572 0 00-1.289-.245h-.019c-.962.01-1.866.381-2.543 1.052-.489.483-.832 1.071-1.01 1.696.46-.347 1.041-.532 1.65-.532z" />
    </svg>
  );
}
...
/**
 * Eye icon for observation/preview features
 */
 ...
 * Kanban/Board icon
 */
export function KanbanIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/**
 * Environment variables/Settings icon
 */
...
/**
 * Code/Terminal icon for env variables
 */
